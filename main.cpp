...
int main() {
  ...
  cout << "building list stringys" << endl;
  strings.AddHead("rhino");
  strings.AddHead("badger");
  strings.AddHead("cat");
  strings.AddHead("dog");
  strings.AddHead("horse");
  cout << "number of nodes = " << strings.NodeCount() << endl;

  strings.PrintForward();

  LinkedList<string> newlist;
  newlist = strings;
  cout << "building list newlist" << endl;

  cout << "number of nodes = " << newlist.NodeCount() << endl;
...
//  cout << "Value of node[1]: " << val2 << " Expected value: " << value2 <<
//  endl; int value3 = list[2]; cout << "Value of node[2]: " << val3 <<
//  "Expected value: " << value3 << endl;

//  cout << "Using brackets operator in a loop to change node values..." <<
//  endl; for (unsigned int i = 0; i < list.NodeCount(); i++)
//    list[i] = i;
...
//  string test =
//      "Test RemoveMe to RemoveMe find RemoveMe all RemoveMe matching ";
...
// void TestOtherRemoval() {
//  cout << "=====Testing RemoveAt() and clearing with
...
//  else
//    cout << "Successfully removed node 100? Weird, there are only 4 nodes..."
//         << endl;
...
// void TestFind() {
//  cout << "=====Testing Find()/GetNode() and InsertBefore()/InsertAfter() "
//          "functionality====="
//       << endl;
//  LinkedList<int> data;
//  data.AddTail(10);
